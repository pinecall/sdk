...
| 📚 [**API Reference**](https://docs.pinecall.io/api/pinecall) | Every class, method, event |
...
All docs live in [`docs/`](./docs) as plain markdown — readable on GitHub, rendered on [docs.pinecall.io](https://docs.pinecall.io).

```
docs/
├── quickstart.md
├── concepts/        # agents, channels, hot-reload, deployment
├── guides/          # how to build X
├── api/             # class reference
